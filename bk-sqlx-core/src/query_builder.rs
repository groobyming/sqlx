...
///
/// [See our FAQ]: https://github.com/launchbadge/bk_sqlx/blob/master/FAQ.md#how-can-i-bind-an-array-to-a-values-clause-how-can-i-do-bulk-inserts
    ...
    DB: Database,
{
    ...
    /// [postgres-limit-issue]: https://github.com/launchbadge/bk_sqlx/issues/671#issuecomment-687043510
    ...
    /// ```rust
    /// # #[cfg(feature = "mysql")] {
    /// use bk_sqlx::{Execute, MySql, QueryBuilder};
