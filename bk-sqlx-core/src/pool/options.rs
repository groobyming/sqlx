...
//
// See: https://github.com/launchbadge/bk_sqlx/issues/2548
...
impl<DB: Database> PoolOptions<DB> {
    ...
    ///
    /// According to `bk_sqlx-bench/benches/pg_pool` this may slightly increase time
    ...
    ///         }
    ///
    ///         let total_memory_usage: i64 = bk_sqlx::query_scalar(
