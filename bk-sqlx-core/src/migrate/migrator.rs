...
impl Migrator {
    ...
    ///
    /// ```rust,no_run
    /// # use bk_sqlx_core::migrate::MigrateError;
    /// # fn main() -> Result<(), MigrateError> {
    /// # bk_sqlx::__rt::test_block_on(async move {
    /// # use bk_sqlx_core::migrate::Migrator;
    /// use std::path::Path;
    ///
    ...
    ///
    /// ```rust,no_run
    /// # use bk_sqlx::migrate::MigrateError;
    /// # fn main() -> Result<(), MigrateError> {
    /// #     bk_sqlx::__rt::test_block_on(async move {
    /// use bk_sqlx::migrate::Migrator;
    /// use bk_sqlx::sqlite::SqlitePoolOptions;
    ///
