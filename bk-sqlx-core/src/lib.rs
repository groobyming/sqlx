...
//! If you are building a custom SQLx driver, you should pin an exact version for `bk_sqlx-core` to
//! avoid breakages:
//!
//! ```toml
//! bk_sqlx-core = { version = "=0.6.2" }
//! ```
//!
...
/// bk_sqlx uses ahash for increased performance, at the cost of reduced DoS resistance.
