...
/// use bk_sqlx::mysql::{MySqlConnectOptions, MySqlConnection, MySqlPool, MySqlSslMode};
///
...
impl MySqlConnectOptions {
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_mysql::{MySqlSslMode, MySqlConnectOptions};
...
impl MySqlConnectOptions {
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_mysql::MySqlConnectOptions;
    /// let options = MySqlConnectOptions::new()
    ///     .host("127.0.0.1");
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_mysql::{MySqlConnectOptions, MySqlSslMode};
    /// let options = MySqlConnectOptions::new();
