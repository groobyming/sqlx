...
fn expand_derive_encode_transparent(
    ...
    generics
        .make_where_clause()
        .predicates
        .push(parse_quote!(#ty: ::bk_sqlx::encode::Encode<#lifetime, DB>));
    let (impl_generics, _, where_clause) = generics.split_for_impl();

    Ok(quote!(
        #[automatically_derived]
        impl #impl_generics ::bk_sqlx::encode::Encode<#lifetime, DB> for #ident #ty_generics
        #where_clause
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::bk_sqlx::database::HasArguments<#lifetime>>::ArgumentBuffer,
            ) -> ::bk_sqlx::encode::IsNull {
                <#ty as ::bk_sqlx::encode::Encode<#lifetime, DB>>::encode_by_ref(&self.0, buf)
            }

            fn produces(&self) -> Option<DB::TypeInfo> {
                <#ty as ::bk_sqlx::encode::Encode<#lifetime, DB>>::produces(&self.0)
            }

            fn size_hint(&self) -> usize {
                <#ty as ::bk_sqlx::encode::Encode<#lifetime, DB>>::size_hint(&self.0)
            }
        }
    ))
}
...
fn expand_derive_encode_weak_enum(
    ...
    Ok(quote!(
        #[automatically_derived]
        impl<'q, DB: ::bk_sqlx::Database> ::bk_sqlx::encode::Encode<'q, DB> for #ident
        where
            #repr: ::bk_sqlx::encode::Encode<'q, DB>,
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::bk_sqlx::database::HasArguments<'q>>::ArgumentBuffer,
            ) -> ::bk_sqlx::encode::IsNull {
                let value = match self {
                    #(#values)*
                };

                <#repr as ::bk_sqlx::encode::Encode<DB>>::encode_by_ref(&value, buf)
            }

            fn size_hint(&self) -> usize {
                <#repr as ::bk_sqlx::encode::Encode<DB>>::size_hint(&Default::default())
            }
        }
    ))
}
...
fn expand_derive_encode_strong_enum(
    ...
    Ok(quote!(
        ...
        impl<'q, DB: ::bk_sqlx::Database> ::bk_sqlx::encode::Encode<'q, DB> for #ident
        where
            &'q ::std::primitive::str: ::bk_sqlx::encode::Encode<'q, DB>,
        {
            fn encode_by_ref(
                &self,
                buf: &mut <DB as ::bk_sqlx::database::HasArguments<'q>>::ArgumentBuffer,
                ...
                <&::std::primitive::str as ::bk_sqlx::encode::Encode<'q, DB>>::encode(val, buf)
            }
            ...
            fn size_hint(&self) -> ::std::primitive::usize {
                ...
                <&::std::primitive::str as ::bk_sqlx::encode::Encode<'q, DB>>::size_hint(&val)
            }
        }
    ))
}
...
fn expand_derive_encode_struct(
    ...
    if cfg!(feature = "postgres") {
        ...
        for field in fields {
            ...
            predicates
                .push(parse_quote!(#ty: for<'q> ::bk_sqlx::encode::Encode<'q, ::bk_sqlx::Postgres>));
            predicates.push(parse_quote!(#ty: ::bk_sqlx::types::Type<::bk_sqlx::Postgres>));
        }
        ...
        let sizes = fields.iter().map(|field| -> Expr {
            ...
            parse_quote!(
                <#ty as ::bk_sqlx::encode::Encode<::bk_sqlx::Postgres>>::size_hint(&self. #id)
            )
        });

        tts.extend(quote!(
            #[automatically_derived]
            impl #impl_generics ::bk_sqlx::encode::Encode<'_, ::bk_sqlx::Postgres> for #ident #ty_generics
            #where_clause
            {
                fn encode_by_ref(
                    &self,
