...
fn expand_derive_decode_transparent(
    ...
    generics
        .make_where_clause()
        .predicates
        .push(parse_quote!(#ty: ::bk_sqlx::decode::Decode<'r, DB>));
    let (impl_generics, _, where_clause) = generics.split_for_impl();

    let tts = quote!(
        #[automatically_derived]
        impl #impl_generics ::bk_sqlx::decode::Decode<'r, DB> for #ident #ty_generics #where_clause {
            fn decode(
                value: <DB as ::bk_sqlx::database::HasValueRef<'r>>::ValueRef,
            ) -> ::std::result::Result<
                Self,
                ::std::boxed::Box<
                ...
                >,
            > {
                <#ty as ::bk_sqlx::decode::Decode<'r, DB>>::decode(value).map(Self)
            }
        }
    );
...
fn expand_derive_decode_weak_enum(
    ...
    Ok(quote!(
        #[automatically_derived]
        impl<'r, DB: ::bk_sqlx::Database> ::bk_sqlx::decode::Decode<'r, DB> for #ident
        where
            #repr: ::bk_sqlx::decode::Decode<'r, DB>,
        {
            fn decode(
                value: <DB as ::bk_sqlx::database::HasValueRef<'r>>::ValueRef,
            ) -> ::std::result::Result<
                ...
                >,
            > {
                let value = <#repr as ::bk_sqlx::decode::Decode<'r, DB>>::decode(value)?;

                match value {
                    #(#arms)*
                    _ => ::std::result::Result::Err(::std::boxed::Box::new(::bk_sqlx::Error::Decode(
...
fn expand_derive_decode_strong_enum(
    ...
    if cfg!(feature = "mysql") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::bk_sqlx::decode::Decode<'r, ::bk_sqlx::mysql::MySql> for #ident {
                fn decode(
                    value: ::bk_sqlx::mysql::MySqlValueRef<'r>,
                ) -> ::std::result::Result<
                    Self,
                    ::std::boxed::Box<
                        dyn ::std::error::Error
                    ...
                    >,
                > {
                    let value = <&'r ::std::primitive::str as ::bk_sqlx::decode::Decode<
                        'r,
                        ::bk_sqlx::mysql::MySql,
                    >>::decode(value)?;
    ...
    if cfg!(feature = "postgres") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::bk_sqlx::decode::Decode<'r, ::bk_sqlx::postgres::Postgres> for #ident {
                fn decode(
    ...
    if cfg!(feature = "sqlite") {
        tts.extend(quote!(
            #[automatically_derived]
            impl<'r> ::bk_sqlx::decode::Decode<'r, ::bk_sqlx::sqlite::Sqlite> for #ident {
                fn decode(
                    value: ::bk_sqlx::sqlite::SqliteValueRef<'r>,
                ) -> ::std::result::Result<
                    Self,
                    ::std::boxed::Box<
                        dyn ::std::error::Error
...
fn expand_derive_decode_struct(
    ...
    if cfg!(feature = "postgres") {
        ...
        for field in fields {
            ...
            predicates.push(parse_quote!(#ty: ::bk_sqlx::decode::Decode<'r, ::bk_sqlx::Postgres>));
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl #impl_generics ::bk_sqlx::decode::Decode<'r, ::bk_sqlx::Postgres> for #ident #ty_generics
            #where_clause
            {
                fn decode(
                    value: ::bk_sqlx::postgres::PgValueRef<'r>,
