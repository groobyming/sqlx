...
fn expand_derive_has_sql_type_transparent(
    ...
    if attr.transparent {
        ...
        generics
            .params
            .insert(0, parse_quote!(DB: ::bk_sqlx::Database));
        generics
            .make_where_clause()
            .predicates
            .push(parse_quote!(#ty: ::bk_sqlx::Type<DB>));
        let (impl_generics, _, where_clause) = generics.split_for_impl();

        array_generics
            .make_where_clause()
            .predicates
            .push(parse_quote!(#ty: ::bk_sqlx::postgres::PgHasArrayType));
        let (array_impl_generics, _, array_where_clause) = array_generics.split_for_impl();

        let mut tokens = quote!(
            #[automatically_derived]
            impl #impl_generics ::bk_sqlx::Type< DB > for #ident #ty_generics #where_clause {
                fn type_info() -> DB::TypeInfo {
                    <#ty as ::bk_sqlx::Type<DB>>::type_info()
                }

                fn compatible(ty: &DB::TypeInfo) -> ::std::primitive::bool {
                    <#ty as ::bk_sqlx::Type<DB>>::compatible(ty)
                }
            }
        );
        ...
        if cfg!(feature = "postgres") && !attr.no_pg_array {
            tokens.extend(quote!(
                #[automatically_derived]
                impl #array_impl_generics ::bk_sqlx::postgres::PgHasArrayType for #ident #ty_generics
                #array_where_clause {
                    fn array_type_info() -> ::bk_sqlx::postgres::PgTypeInfo {
                        <#ty as ::bk_sqlx::postgres::PgHasArrayType>::array_type_info()
                    }
                }
            ));
        }
    ...
    if cfg!(feature = "postgres") {
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl ::bk_sqlx::Type<::bk_sqlx::postgres::Postgres> for #ident #ty_generics {
                fn type_info() -> ::bk_sqlx::postgres::PgTypeInfo {
                    ::bk_sqlx::postgres::PgTypeInfo::with_name(#ty_name)
                }
            }
        ));
    }
...
fn expand_derive_has_sql_type_weak_enum(
    ...
    let ts = quote!(
        #[automatically_derived]
        impl<DB: ::bk_sqlx::Database> ::bk_sqlx::Type<DB> for #ident
        where
            #repr: ::bk_sqlx::Type<DB>,
        {
            fn type_info() -> DB::TypeInfo {
                <#repr as ::bk_sqlx::Type<DB>>::type_info()
            }

            fn compatible(ty: &DB::TypeInfo) -> bool {
                <#repr as ::bk_sqlx::Type<DB>>::compatible(ty)
            }
        }
    );
...
fn expand_derive_has_sql_type_strong_enum(
    ...
    if cfg!(feature = "mysql") {
        tts.extend(quote!(
            #[automatically_derived]
            impl ::bk_sqlx::Type<::bk_sqlx::MySql> for #ident {
                fn type_info() -> ::bk_sqlx::mysql::MySqlTypeInfo {
                    ::bk_sqlx::mysql::MySqlTypeInfo::__enum()
                }

                fn compatible(ty: &::bk_sqlx::mysql::MySqlTypeInfo) -> ::std::primitive::bool {
                    *ty == ::bk_sqlx::mysql::MySqlTypeInfo::__enum()
                }
            }
        ));
    }
    ...
    if cfg!(feature = "postgres") {
        ...
        tts.extend(quote!(
            #[automatically_derived]
            impl ::bk_sqlx::Type<::bk_sqlx::Postgres> for #ident {
                fn type_info() -> ::bk_sqlx::postgres::PgTypeInfo {
                    ::bk_sqlx::postgres::PgTypeInfo::with_name(#ty_name)
                }
            }
    ...
    if cfg!(feature = "sqlite") {
        tts.extend(quote!(
            #[automatically_derived]
            impl bk_sqlx::Type<::bk_sqlx::Sqlite> for #ident {
                fn type_info() -> ::bk_sqlx::sqlite::SqliteTypeInfo {
                    <::std::primitive::str as ::bk_sqlx::Type<bk_sqlx::Sqlite>>::type_info()
                }

                fn compatible(ty: &::bk_sqlx::sqlite::SqliteTypeInfo) -> ::std::primitive::bool {
                    <&::std::primitive::str as ::bk_sqlx::types::Type<bk_sqlx::sqlite::Sqlite>>::compatible(ty)
                }
            }
        ));
    }
