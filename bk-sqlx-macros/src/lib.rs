...
#[proc_macro_derive(Encode, attributes(bk_sqlx))]
...
#[proc_macro_derive(Decode, attributes(bk_sqlx))]
...
#[proc_macro_derive(Type, attributes(bk_sqlx))]
...
#[proc_macro_derive(FromRow, attributes(bk_sqlx))]
