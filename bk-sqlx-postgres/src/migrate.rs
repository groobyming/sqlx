...
pub(crate) use bk_sqlx_core::migrate::MigrateError;
pub(crate) use bk_sqlx_core::migrate::{AppliedMigration, Migration};
pub(crate) use bk_sqlx_core::migrate::{Migrate, MigrateDatabase};
...
impl Migrate for PgConnection {
    fn ensure_migrations_table(&mut self) -> BoxFuture<'_, Result<(), MigrateError>> {
        Box::pin(async move {
            ...
            self.execute(
                r#"
CREATE TABLE IF NOT EXISTS _bk_sqlx_migrations (
    ...
    fn dirty_version(&mut self) -> BoxFuture<'_, Result<Option<i64>, MigrateError>> {
        Box::pin(async move {
            ...
            let row: Option<(i64,)> = query_as(
                "SELECT version FROM _bk_sqlx_migrations WHERE success = false ORDER BY version LIMIT 1",
            )
            .fetch_optional(self)
            .await?;
    ...
    fn list_applied_migrations(
        ...
        Box::pin(async move {
            ...
            let rows: Vec<(i64, Vec<u8>)> =
                query_as("SELECT version, checksum FROM _bk_sqlx_migrations ORDER BY version")
                    .fetch_all(self)
                    .await?;
    ...
    fn apply<'e: 'm, 'm>(
        ...
        Box::pin(async move {
            ...
            // execute migrations twice. See https://github.com/launchbadge/bk_sqlx/issues/1966.
            ...
            let _ = query(
                r#"
    INSERT INTO _bk_sqlx_migrations ( version, description, success, checksum, execution_time )
    VALUES ( $1, $2, TRUE, $3, -1 )
                "#,
            )
    ...
    fn revert<'e: 'm, 'm>(
        ...
        Box::pin(async move {
            ...
            // language=SQL
            let _ = query(r#"DELETE FROM _bk_sqlx_migrations WHERE version = $1"#)
                .bind(migration.version)
                .execute(&mut *tx)
                .await?;
