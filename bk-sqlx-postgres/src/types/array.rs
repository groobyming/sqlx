...
///
/// ### Note: `#[derive(bk_sqlx::Type)]`
/// If you have the `postgres` feature enabled, `#[derive(bk_sqlx::Type)]` will also generate
/// an impl of this trait for your type if your wrapper is marked `#[bk_sqlx(transparent)]`:
///
/// ```rust,ignore
/// #[derive(bk_sqlx::Type)]
/// #[bk_sqlx(transparent)]
