...
///
/// ```rust,no_run
/// use bk_sqlx::{Connection, ConnectOptions};
/// use bk_sqlx::postgres::{PgConnectOptions, PgConnection, PgPool, PgSslMode};
///
...
impl PgConnectOptions {
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_postgres::PgConnectOptions;
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_postgres::{PgSslMode, PgConnectOptions};
    /// let options = PgConnectOptions::new()
    ///     .ssl_mode(PgSslMode::Require);
    /// ```
...
impl PgConnectOptions {
    ...
    ///
    /// ```rust
    /// # use bk_sqlx_postgres::{PgConnectOptions, PgSslMode};
    /// let options = PgConnectOptions::new();
...
fn test_options_formatting() {
    ...
    let options = options.options([("search_path", "bk_sqlx")]);
    assert_eq!(
        options.options,
        Some("-c geqo=off -c search_path=bk_sqlx".to_string())
    );
