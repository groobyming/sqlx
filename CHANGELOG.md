...
[#216]: https://github.com/launchbadge/bk-sqlx/pull/216
[#214]: https://github.com/launchbadge/bk-sqlx/pull/214
[#213]: https://github.com/launchbadge/bk-sqlx/pull/213
...
[#212]: https://github.com/launchbadge/bk-sqlx/issues/212
...
[#200]: https://github.com/launchbadge/bk-sqlx/pull/200
[#203]: https://github.com/launchbadge/bk-sqlx/issues/203
[#204]: https://github.com/launchbadge/bk-sqlx/issues/204

## 0.3.0 - 2020-03-29

### Breaking Changes

-   `bk-sqlx::Row` now has a lifetime (`'c`) tied to the database connection. In effect, this means that you cannot store `Row`s or collect
    them into a collection. `Query` (returned from `bk-sqlx::query()`) has `map()` which takes a function to map from the `Row` to
    another type to make this transition easier.

    In 0.2.x

    ```rust
    let rows = bk-sqlx::query("SELECT 1")
        .fetch_all(&mut conn).await?;
    ```
    ...
    ```rust
    let values: Vec<i32> = bk-sqlx::query("SELECT 1")
        .map(|row: PgRow| row.get(0))
        .fetch_all(&mut conn).await?;
    ```

    To assist with the above, `bk-sqlx::query_as()` now supports querying directly into tuples (up to 9 elements) or
    struct types with a `#[derive(FromRow)]`.

    ```rust
    // This extension trait is needed until a rust bug is fixed
    use bk-sqlx::postgres::PgQueryAs;

    let values: Vec<(i32, bool)> = bk-sqlx::query_as("SELECT 1, false")
        .fetch_all(&mut conn).await?;
    ```
...
-   [[#97]] [[#134]] Add support for user-defined types. [[@Freax13]]
    ...
    -   Enumerations may be defined in Rust and can match SQL by integer discriminant or variant name.
        ...
        ```rust
        #[derive(bk-sqlx::Type)]
        #[bk-sqlx(rename = "TEXT")] // May also be the name of a user defined enum type
        #[bk-sqlx(rename_all = "lowercase")] // similar to serde rename_all
...
[#62]: https://github.com/launchbadge/bk-sqlx/issues/62
[#130]: https://github.com/launchbadge/bk-sqlx/issues/130
[#98]: https://github.com/launchbadge/bk-sqlx/pull/98
[#97]: https://github.com/launchbadge/bk-sqlx/pull/97
[#134]: https://github.com/launchbadge/bk-sqlx/pull/134
[#129]: https://github.com/launchbadge/bk-sqlx/pull/129
[#131]: https://github.com/launchbadge/bk-sqlx/pull/131
[#135]: https://github.com/launchbadge/bk-sqlx/pull/135
[#108]: https://github.com/launchbadge/bk-sqlx/pull/108

## 0.2.6 - 2020-03-10

### Added

-   [[#114]] Export `bk-sqlx_core::Transaction` [[@thedodd]]
...
[#105]: https://github.com/launchbadge/bk-sqlx/pull/105
[#109]: https://github.com/launchbadge/bk-sqlx/pull/109
[#114]: https://github.com/launchbadge/bk-sqlx/pull/114
[#125]: https://github.com/launchbadge/bk-sqlx/pull/125
[#126]: https://github.com/launchbadge/bk-sqlx/pull/126
...
[#84]: https://github.com/launchbadge/bk-sqlx/issues/84
[#100]: https://github.com/launchbadge/bk-sqlx/issues/100
[#104]: https://github.com/launchbadge/bk-sqlx/issues/104
...
[#72]: https://github.com/launchbadge/bk-sqlx/issues/72
[#96]: https://github.com/launchbadge/bk-sqlx/issues/96
[#71]: https://github.com/launchbadge/bk-sqlx/issues/71
...
[#57]: https://github.com/launchbadge/bk-sqlx/issues/57
...
-   [[#66]] Declare used features for `tokio` in `bk-sqlx-macros` explicitly

[#66]: https://github.com/launchbadge/bk-sqlx/issues/66
...
[#64]: https://github.com/launchbadge/bk-sqlx/pull/64
[#65]: https://github.com/launchbadge/bk-sqlx/pull/65

-   [[#55]] Use a shared tokio runtime for the `query!` macro compile-time execution (under the `runtime-tokio` feature) [[@udoprog]]

[#55]: https://github.com/launchbadge/bk-sqlx/pull/55

## 0.2.0 - 2020-01-15

### Fixed

-   https://github.com/launchbadge/bk-sqlx/issues/47
...
-   Support SQL transactions. You may now use the `begin()` function on `Pool` or `Connection` to
    start a new SQL transaction. This returns `bk-sqlx::Transaction` which will `ROLLBACK` on `Drop`
...
-   https://github.com/launchbadge/bk-sqlx/issues/43

-   https://github.com/launchbadge/bk-sqlx/issues/40

### Added

-   Support for `SCRAM-SHA-256` authentication in Postgres [#37](https://github.com/launchbadge/bk-sqlx/pull/37) [@danielakhterov](https://github.com/danielakhterov)

-   Implement `Debug` for Pool [#42](https://github.com/launchbadge/bk-sqlx/pull/42) [@prettynatty](https://github.com/prettynatty)

## 0.1.3 - 2020-01-06

### Fixed

-   https://github.com/launchbadge/bk-sqlx/issues/30
