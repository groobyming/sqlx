...
bk_sqlx_core::declare_driver_with_optional_migrate!(DRIVER = Sqlite);
    ...
    fn fetch_many<'q>(
        ...
        Box::pin(
            self.worker
                ...
                .try_flatten_stream()
                .map(
                    move |res: bk_sqlx_core::Result<Either<SqliteQueryResult, SqliteRow>>| match res? {
